...
describe('Device Detection Utilities', () => {
  ...
  it('detects mobile devices correctly', () => {
    ...
    Object.defineProperty(navigatorSpy, 'userAgent', {
      get: () => 'Mozilla/5.0 (Linux; Android 10; SM-G973F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.210 Mobile Safari/537.36',
      configurable: true
    });
    ...
    // iPhone
    Object.defineProperty(navigatorSpy, 'userAgent', {
      get: () => 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.1 Mobile/15E148 Safari/604.1',
      configurable: true
    });
    expect(isMobile()).toBe(true);
  ...
  it('detects tablet devices correctly', () => {
    // iPad
    Object.defineProperty(navigatorSpy, 'userAgent', {
      get: () => 'Mozilla/5.0 (iPad; CPU OS 14_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0 Mobile/15E148 Safari/604.1',
      configurable: true
    });
