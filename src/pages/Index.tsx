...
const Index = () => {
  ...
  return (
    <div className="min-h-screen max-w-full mx-auto overflow-x-hidden flex flex-col items-center justify-center p-4 bg-gradient-to-br from-purple-800 via-fuchsia-500 to-pink-400 dark:from-purple-900 dark:via-gray-900 dark:to-black">
      {isMerchant ? (
        showLogin ? (
          <MerchantLoginForm />
        ) : (
